...
const ItemDetailContainer = () => {
    ...
    useEffect(() => {
        const fetchItemDetail = async () => {
            const productos = [
                { id: 1, name: "Pc AMD Ryzen 3 3200g 8Gb SSD 240", descripcion:"PC ideal para uso hogareño y de oficina, excelente relación entre precio y potencia.", categoria: "PC Armadas" },
